...
class BaseProperty(models.Model):
    ...
    owner = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="properties_created", default=1
    )

    saved_by_users = models.ManyToManyField(
        User, through="SavedProperty", related_name="saved_properties"
    )
...
class SavedProperty(models.Model):
    ...
    property = models.ForeignKey(
        BaseProperty, on_delete=models.CASCADE, null=True, blank=True
    )
