...
from property_rental_marketplace.profile_management.models import NewsletterFollower, AdminNewsLetterPost
...
def send_notification_to_followers(sender, instance, **kwargs):
    ...
    message = f"A new newsletter post has been published: {instance.content}. Check it out on the About page."
